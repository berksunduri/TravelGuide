...
class TransportationPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recyclerViewTransportation)
        recyclerView.layoutManager = LinearLayoutManager(this)
        postsAdapter = PostsAdapter(transportation)
        ...
        databaseReference = FirebaseDatabase.getInstance().reference.child("Posts").child(transportation)
